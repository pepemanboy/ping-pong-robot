...
(cl:defmethod cl:initialize-instance :after ((m <JointVelocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointVelocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinova_msgs-msg:<JointVelocity> is deprecated: use kinova_msgs-msg:JointVelocity instead.")))

(cl:ensure-generic-function 'joint1-val :lambda-list '(m))
(cl:defmethod joint1-val ((m <JointVelocity>))
...
(cl:defmethod joint2-val ((m <JointVelocity>))
...
(cl:defmethod joint3-val ((m <JointVelocity>))
...
(cl:defmethod joint4-val ((m <JointVelocity>))
...
(cl:defmethod joint5-val ((m <JointVelocity>))
...
(cl:defmethod joint6-val ((m <JointVelocity>))
...
(cl:defmethod joint7-val ((m <JointVelocity>))
