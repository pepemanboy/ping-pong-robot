...
(cl:defmethod cl:initialize-instance :after ((m <JointTorque>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTorque)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinova_msgs-msg:<JointTorque> is deprecated: use kinova_msgs-msg:JointTorque instead.")))

(cl:ensure-generic-function 'joint1-val :lambda-list '(m))
(cl:defmethod joint1-val ((m <JointTorque>))
...
(cl:defmethod joint2-val ((m <JointTorque>))
...
(cl:defmethod joint3-val ((m <JointTorque>))
...
(cl:defmethod joint4-val ((m <JointTorque>))
...
(cl:defmethod joint5-val ((m <JointTorque>))
...
(cl:defmethod joint6-val ((m <JointTorque>))
...
(cl:defmethod joint7-val ((m <JointTorque>))
